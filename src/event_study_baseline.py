...
PROJECT = {"analysis_type": "event_study", "category": "Market Signals & Event Analytics", "columns": ["event_id", "event_date", "symbol", "event_tone", "market_return", "stock_return_t_minus_1", "stock_return_t0", "stock_return_t_plus_1"], "methods": ["이벤트 윈도우 -1, 0, +1일의 주식수익률에서 시장수익률을 차감해 abnormal return을 만든다.", "CAR를 톤별로 비교해 이벤트 영향의 방향성과 지속성을 확인한다.", "이벤트와 수익률은 이벤트 스터디 계산 흐름을 설명하는 합성 예시다."], "module_name": "event_study_baseline", "objective": "CEO 발언 이벤트 주변의 abnormal return과 누적반응을 요약한다.", "question": "CEO의 공개 발언 톤은 이벤트 당일과 직후 주가 반응에 어떤 차이를 만드는가?", "rows": [["E001", "2026-02-03", "AAA", "positive", 0.002, 0.001, 0.018, 0.006], ["E002", "2026-02-14", "BBB", "negative", -0.003, -0.004, -0.026, -0.011], ["E003", "2026-02-20", "CCC", "neutral", 0.001, 0.002, 0.004, -0.001], ["E004", "2026-03-02", "AAA", "negative", -0.002, 0.0, -0.017, -0.006]], "sample_name": "ceo_event_returns.csv", "title_en": "CEO Twitter Market Impact", "title_ko": "CEO 트위터 시장 영향"}
